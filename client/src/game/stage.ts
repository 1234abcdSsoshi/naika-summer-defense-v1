...
export const STAGE_PRESENTATIONS: Record<StageId, StagePresentation> = {
  ...
  dusk: {
    ...
    titleAction: "夕暮れを守る",
    background: "/manus-storage/naika-room-background-dusk-japanese-zen_712ebe6a.png",
  ...
  night: {
    ...
    titleAction: "夜を守る",
    background: "/manus-storage/naika-room-background-night-japanese-zen_c63f1fce.png",
