...
export const STAGE_PRESENTATIONS: Record<StageId, StagePresentation> = {
  morning: {
    ...
    titleAction: "朝を守る",
    background: "/manus-storage/naika-room-background-morning-no-chime-balanced_9f94f6eb.png",
  ...
  dusk: {
    ...
    titleAction: "夕暮れを守る",
    background: "/manus-storage/naika-room-background-dusk-no-chime-balanced_f40df828.png",
